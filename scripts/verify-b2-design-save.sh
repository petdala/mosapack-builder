...
if ! rg -q 'designStorageConsent' "$BUILDER" || ! rg -q 'temporarily store this design and preview image|I consent to save my cropped preview and mosaic details|I’d like MosaPack to review my design and follow up by email' "$BUILDER"; then
