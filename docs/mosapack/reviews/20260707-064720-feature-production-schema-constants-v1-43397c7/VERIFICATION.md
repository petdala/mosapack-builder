...
Low-confidence sensitive identifier hits: 410
...
- `scripts/security-scan.sh` reported no high-confidence credentials and 410 low-confidence sensitive identifier hits in docs/scripts.
- `scripts/verify-generate-kit-pack.sh` preserved `pending_measurement_record` behavior and validated First Hello plus Pixel Portrait outputs.
