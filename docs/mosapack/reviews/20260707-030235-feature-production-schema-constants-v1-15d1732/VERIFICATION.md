...
Low-confidence sensitive identifier hits: 370
...
`verify-generate-kit-pack.sh` generated normal and Gate A PDFs under `/tmp/mosapack-generate-kit-pack-verify/`, confirmed both generated PDFs/manifests are non-empty, confirmed the Gate A PDF has exactly 5 pages, confirmed Gate A manifest bleed values `0.03` and `0.05`, and confirmed PDF text includes `MosaPack`, `MP-FH24A`, `Actual Size`, `Measure me: 1.000 in`, `Vertical check: 1.000 in`, `feed/skew fiducials`, and the multi-sheet section note.
