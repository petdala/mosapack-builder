...
Low-confidence sensitive identifier hits: 394
...
- `scripts/security-scan.sh` reported no high-confidence credentials and 394 low-confidence sensitive identifier hits in docs/scripts.
- `scripts/verify-generate-kit-pack.sh` generated temporary PDFs/manifests under `/tmp` and preserved the expected `OL2050 is not production verified: pending_alignment_test` warning.
