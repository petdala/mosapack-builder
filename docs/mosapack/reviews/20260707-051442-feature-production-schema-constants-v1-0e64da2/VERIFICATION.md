...
Low-confidence sensitive identifier hits: 386
...
`verify-generate-kit-pack.sh` confirmed default generation, `--fulfillment printed_mixed`, `--fulfillment stock`, `--fulfillment hybrid`, and Gate A generation. Stock and hybrid outputs remained 5-page normal operator PDFs, so fulfillment modes did not add print pages. Manifests parsed and included stock/hybrid fulfillment fields.
