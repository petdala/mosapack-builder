...
Low-confidence sensitive identifier hits: 418
...
Notes:
- `scripts/verify-generate-kit-pack.sh` reports `OL2050 is not production verified: pending_measurement_record`; this is expected until exact physical measurement records are available.
