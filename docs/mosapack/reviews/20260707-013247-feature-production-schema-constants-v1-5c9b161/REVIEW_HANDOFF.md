...
This branch implements Canonical Design Export Adapter v1 on top of the production schema/constants branch. It adds an operator-only `Download Canonical Design JSON` export that converts the current proof state into schema-aligned `mosapack-design-v1.json` for future generator input. The generator is not ported, public customer UX is unchanged, and production was not deployed.

## Repo

- Path: `/Users/dereksolas/Developer/mosapack-clean`
- Branch: `feature/production-schema-constants-v1`
- Source commit reviewed: `5c9b161`
- Report commit: generated after this report is committed
- Timestamp: `20260707-013247`
- Production URL: https://mosapack.netlify.app
- Preview URL: https://6a4c8f42fbbb24eaabad0e77--mosapack.netlify.app
- GitHub branch/PR link: [Paste GitHub link here after push]

## Scope Warning

WARNING: This branch includes public builder export code, but only inside collapsed operator Proof Export Tools. Review canonical JSON shape, validation, and B2/Form preservation before merge.
