...
- `scripts/verify-buildable-proof-output.sh`: exists
- `scripts/verify-production-constants-schema.sh`: exists
- `scripts/verify-canonical-design-export.sh`: exists
...
Low-confidence sensitive identifier hits: 346
