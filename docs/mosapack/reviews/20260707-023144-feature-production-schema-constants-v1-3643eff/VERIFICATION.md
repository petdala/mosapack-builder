...
Low-confidence sensitive identifier hits: 362
...
```text
Netlify proof form export/raw image check: metadata only.
Buildable proof output verification passed.
```
Result: PASS
...
```text
Production constants/schema verification passed.
```
Result: PASS
...
```text
Netlify proof form canonical/export/raw image check: metadata only.
Canonical design export verification passed.
```
Result: PASS
...
```text
WARNING: OL2050 is not production verified: pending_alignment_test
Manifest checks passed.
PDF check passed: first-hello-kit.pdf: 5 pages, first page 612.0x792.0 pt
PDF check passed: first-hello-gate-a.pdf: 5 pages, first page 612.0x792.0 pt
Kit pack generator verification passed.
```
Result: PASS
