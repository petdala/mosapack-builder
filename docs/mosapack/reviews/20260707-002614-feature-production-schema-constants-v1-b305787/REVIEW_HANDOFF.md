...
This branch lands draft production constants and canonical design schema v1.1 on top of Buildable Sticker/Magnet Proof Output v1. It does not port `generate_kit_pack.py` into runtime. The review focus is the schema/constants contract, synthetic fixture, current production JSON diff, adapter plan, and generator-port readiness.

## Repo

- Path: `/Users/dereksolas/Developer/mosapack-clean`
- Branch: `feature/production-schema-constants-v1`
- Source commit reviewed: `b305787`
- Report commit: generated after this report is committed
- Timestamp: `20260707-002614`
- Production URL: https://mosapack.netlify.app
- Preview URL: not created for this docs/schema task
- GitHub branch/PR link: [Paste GitHub link here after push]

## Scope Warning

WARNING: This branch is schema/docs/config only. It must not be treated as generator runtime work or production approval.
