...
Low-confidence sensitive identifier hits: 434
...
- Draft preview URL: `https://6a4cf909488573007582443f--mosapack.netlify.app`
- Desktop upload state: no forbidden rendered-copy matches; no horizontal overflow.
- Mobile 390px upload state: `scrollWidth` matched viewport width.
- Live proof smoke: pass.
- Proof smoke project ID: `4739c176-0fc8-4702-acc7-8f425c36c6f3`
